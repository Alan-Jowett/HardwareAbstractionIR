...
| WCH | `ch32v203c8t6` | `evidence/wch/ch32v203c8t6/hair.json` | `rcc`, `gpio-port`, `uart`, `usart`, `spi`, `i2c`, `timer`, `pwm`, `adc`, `dma`, `flash`, `interrupt` | No QEMU path; checked-in CH32 hardware smoke harnesses cover Embassy blink, USB CDC, ADC DMA, watchdog, flash, and GPIO EXTI wait packaging |
