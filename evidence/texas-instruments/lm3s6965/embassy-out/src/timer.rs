...
pub const DRV_TIMER0_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding { id: "clk.timer0", name: "TIMER0", consumer_ref: "periph.timer0", clock_ref: "clock.sysclk", controller_ref: Some("block.rcc"), binding_kind: "gated", control_refs: &["reg.sysctl.rcgc1"], enable_operation_refs: &[], disable_operation_refs: &[] }];
pub const DRV_TIMER0_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding { id: "rst.timer0", name: "TIMER0", target_ref: "periph.timer0", controller_ref: Some("block.rcc"), reset_domain_ref: Some("rd.software"), binding_kind: "software", control_refs: &["reg.sysctl.srcr1"], assert_operation_refs: &[], release_operation_refs: &[] }];
pub const DRV_TIMER0_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource { id: "isrc.timer0a", name: "TIMER0A interrupt source", source_ref: "periph.timer0", producer_ref: Some("periph.timer0"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }, metadata::InterruptSource { id: "isrc.timer0b", name: "TIMER0B interrupt source", source_ref: "periph.timer0", producer_ref: Some("periph.timer0"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }];
pub const DRV_TIMER0_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute { id: "iroute.timer0a", name: "TIMER0A interrupt source route", source_ref: "isrc.timer0a", interrupt_ref: "int.timer0a", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }, metadata::InterruptRoute { id: "iroute.timer0b", name: "TIMER0B interrupt source route", source_ref: "isrc.timer0b", interrupt_ref: "int.timer0b", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }];
pub const DRV_TIMER0_DMA_CHANNELS: &[metadata::DmaChannel] = &[];
pub const DRV_TIMER0_DMA_ROUTES: &[metadata::DmaRoute] = &[];
pub const DRV_TIMER0_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute { id: "pinroute.timer0.ccp0.pd4", name: "CCP0 on PD4", pin_ref: "pin.pd4", peripheral_ref: "periph.timer0", signal: "CCP0", route_type: "hardwired", control_refs: &["reg.gpiod.afsel", "reg.gpiod.den"], electrical_constraint_refs: &[], conflict_refs: &[], default_after_reset: Some(false) }];
pub const DRV_TIMER0_PIN_ROLES: &[metadata::PinRole] = &[metadata::PinRole { role: "ccp0", signal: "CCP0", routes: DRV_TIMER0_PIN_ROLE_0_ROUTES, requirement: metadata::ResourceRequirement::Optional }];
pub const DRV_TIMER0_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[metadata::SemanticOperation { id: "op.timer0.enable", name: "Enable TIMER0A", description: None, kind: Some("initialization"), target_refs: &["periph.timer0"], steps: &[metadata::SemanticOperationStep { index: 0, action: "write", target_ref: Some("reg.timer0.ctl"), expression: Some(metadata::SemanticExpression { language: Some("plain"), text: "Set TAEN = 1" }), value: None, description: Some("Set TAEN to start Timer A.") }], preconditions: &[], postconditions: &[] }];
pub const DRV_TIMER0_STATE_MACHINES: &[metadata::SemanticStateMachine] = &[metadata::SemanticStateMachine { id: "sm.timer0.a", name: "TIMER0A enable state", description: None, target_refs: &["periph.timer0"], initial_state: Some("disabled"), states: &[metadata::SemanticState { name: "disabled", description: Some("Timer A is not enabled."), invariants: &[] }, metadata::SemanticState { name: "running", description: Some("Timer A is enabled and counting."), invariants: &[] }], transitions: &[metadata::SemanticTransition { from: "disabled", to: "running", trigger: Some("Set CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "starts-hardware", target_ref: Some("field.timer0.ctl.taen"), description: Some("Timer A starts counting when TAEN is set.") }] }, metadata::SemanticTransition { from: "running", to: "disabled", trigger: Some("Clear CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "stops-hardware", target_ref: Some("field.timer0.ctl.taen"), description: Some("Timer A stops when TAEN is cleared.") }] }] }];
...
pub const DRV_TIMER1_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource { id: "isrc.timer1a", name: "TIMER1A interrupt source", source_ref: "periph.timer1", producer_ref: Some("periph.timer1"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }, metadata::InterruptSource { id: "isrc.timer1b", name: "TIMER1B interrupt source", source_ref: "periph.timer1", producer_ref: Some("periph.timer1"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }];
pub const DRV_TIMER1_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute { id: "iroute.timer1a", name: "TIMER1A interrupt source route", source_ref: "isrc.timer1a", interrupt_ref: "int.timer1a", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }, metadata::InterruptRoute { id: "iroute.timer1b", name: "TIMER1B interrupt source route", source_ref: "isrc.timer1b", interrupt_ref: "int.timer1b", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }];
pub const DRV_TIMER1_DMA_CHANNELS: &[metadata::DmaChannel] = &[];
pub const DRV_TIMER1_DMA_ROUTES: &[metadata::DmaRoute] = &[];
pub const DRV_TIMER1_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute { id: "pinroute.timer1.ccp1.pd7", name: "CCP1 on PD7", pin_ref: "pin.pd7", peripheral_ref: "periph.timer1", signal: "CCP1", route_type: "hardwired", control_refs: &["reg.gpiod.afsel", "reg.gpiod.den"], electrical_constraint_refs: &[], conflict_refs: &[], default_after_reset: Some(false) }];
pub const DRV_TIMER1_PIN_ROLES: &[metadata::PinRole] = &[metadata::PinRole { role: "ccp1", signal: "CCP1", routes: DRV_TIMER1_PIN_ROLE_0_ROUTES, requirement: metadata::ResourceRequirement::Optional }];
pub const DRV_TIMER1_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[metadata::SemanticOperation { id: "op.timer1.enable", name: "Enable TIMER1A", description: None, kind: Some("initialization"), target_refs: &["periph.timer1"], steps: &[metadata::SemanticOperationStep { index: 0, action: "write", target_ref: Some("reg.timer1.ctl"), expression: Some(metadata::SemanticExpression { language: Some("plain"), text: "Set TAEN = 1" }), value: None, description: Some("Set TAEN to start Timer A.") }], preconditions: &[], postconditions: &[] }];
pub const DRV_TIMER1_STATE_MACHINES: &[metadata::SemanticStateMachine] = &[metadata::SemanticStateMachine { id: "sm.timer1.a", name: "TIMER1A enable state", description: None, target_refs: &["periph.timer1"], initial_state: Some("disabled"), states: &[metadata::SemanticState { name: "disabled", description: Some("Timer A is not enabled."), invariants: &[] }, metadata::SemanticState { name: "running", description: Some("Timer A is enabled and counting."), invariants: &[] }], transitions: &[metadata::SemanticTransition { from: "disabled", to: "running", trigger: Some("Set CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "starts-hardware", target_ref: Some("field.timer1.ctl.taen"), description: Some("Timer A starts counting when TAEN is set.") }] }, metadata::SemanticTransition { from: "running", to: "disabled", trigger: Some("Clear CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "stops-hardware", target_ref: Some("field.timer1.ctl.taen"), description: Some("Timer A stops when TAEN is cleared.") }] }] }];
...
pub const DRV_TIMER2_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource { id: "isrc.timer2a", name: "TIMER2A interrupt source", source_ref: "periph.timer2", producer_ref: Some("periph.timer2"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }, metadata::InterruptSource { id: "isrc.timer2b", name: "TIMER2B interrupt source", source_ref: "periph.timer2", producer_ref: Some("periph.timer2"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }];
pub const DRV_TIMER2_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute { id: "iroute.timer2a", name: "TIMER2A interrupt source route", source_ref: "isrc.timer2a", interrupt_ref: "int.timer2a", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }, metadata::InterruptRoute { id: "iroute.timer2b", name: "TIMER2B interrupt source route", source_ref: "isrc.timer2b", interrupt_ref: "int.timer2b", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }];
pub const DRV_TIMER2_DMA_CHANNELS: &[metadata::DmaChannel] = &[];
pub const DRV_TIMER2_DMA_ROUTES: &[metadata::DmaRoute] = &[];
pub const DRV_TIMER2_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute { id: "pinroute.timer2.ccp2.pd5", name: "CCP2 on PD5", pin_ref: "pin.pd5", peripheral_ref: "periph.timer2", signal: "CCP2", route_type: "hardwired", control_refs: &["reg.gpiod.afsel", "reg.gpiod.den"], electrical_constraint_refs: &[], conflict_refs: &[], default_after_reset: Some(false) }];
pub const DRV_TIMER2_PIN_ROLES: &[metadata::PinRole] = &[metadata::PinRole { role: "ccp2", signal: "CCP2", routes: DRV_TIMER2_PIN_ROLE_0_ROUTES, requirement: metadata::ResourceRequirement::Optional }];
pub const DRV_TIMER2_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[metadata::SemanticOperation { id: "op.timer2.enable", name: "Enable TIMER2A", description: None, kind: Some("initialization"), target_refs: &["periph.timer2"], steps: &[metadata::SemanticOperationStep { index: 0, action: "write", target_ref: Some("reg.timer2.ctl"), expression: Some(metadata::SemanticExpression { language: Some("plain"), text: "Set TAEN = 1" }), value: None, description: Some("Set TAEN to start Timer A.") }], preconditions: &[], postconditions: &[] }];
pub const DRV_TIMER2_STATE_MACHINES: &[metadata::SemanticStateMachine] = &[metadata::SemanticStateMachine { id: "sm.timer2.a", name: "TIMER2A enable state", description: None, target_refs: &["periph.timer2"], initial_state: Some("disabled"), states: &[metadata::SemanticState { name: "disabled", description: Some("Timer A is not enabled."), invariants: &[] }, metadata::SemanticState { name: "running", description: Some("Timer A is enabled and counting."), invariants: &[] }], transitions: &[metadata::SemanticTransition { from: "disabled", to: "running", trigger: Some("Set CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "starts-hardware", target_ref: Some("field.timer2.ctl.taen"), description: Some("Timer A starts counting when TAEN is set.") }] }, metadata::SemanticTransition { from: "running", to: "disabled", trigger: Some("Clear CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "stops-hardware", target_ref: Some("field.timer2.ctl.taen"), description: Some("Timer A stops when TAEN is cleared.") }] }] }];
...
pub const DRV_TIMER3_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource { id: "isrc.timer3a", name: "TIMER3A interrupt source", source_ref: "periph.timer3", producer_ref: Some("periph.timer3"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }, metadata::InterruptSource { id: "isrc.timer3b", name: "TIMER3B interrupt source", source_ref: "periph.timer3", producer_ref: Some("periph.timer3"), kind: "timer", flag_refs: &[], clear_operation_refs: &[] }];
pub const DRV_TIMER3_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute { id: "iroute.timer3a", name: "TIMER3A interrupt source route", source_ref: "isrc.timer3a", interrupt_ref: "int.timer3a", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }, metadata::InterruptRoute { id: "iroute.timer3b", name: "TIMER3B interrupt source route", source_ref: "isrc.timer3b", interrupt_ref: "int.timer3b", controller_ref: "block.nvic", cpu_target_ref: Some("block.cpu0"), line_index: None, route_type: "hardwired", control_refs: &[], acknowledge_operation_refs: &[], shared_group: None }];
pub const DRV_TIMER3_DMA_CHANNELS: &[metadata::DmaChannel] = &[];
pub const DRV_TIMER3_DMA_ROUTES: &[metadata::DmaRoute] = &[];
pub const DRV_TIMER3_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute { id: "pinroute.timer3.ccp3.pc6", name: "CCP3 on PC6", pin_ref: "pin.pc6", peripheral_ref: "periph.timer3", signal: "CCP3", route_type: "hardwired", control_refs: &["reg.gpioc.afsel", "reg.gpioc.den"], electrical_constraint_refs: &[], conflict_refs: &[], default_after_reset: Some(false) }];
pub const DRV_TIMER3_PIN_ROLES: &[metadata::PinRole] = &[metadata::PinRole { role: "ccp3", signal: "CCP3", routes: DRV_TIMER3_PIN_ROLE_0_ROUTES, requirement: metadata::ResourceRequirement::Optional }];
pub const DRV_TIMER3_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[metadata::SemanticOperation { id: "op.timer3.enable", name: "Enable TIMER3A", description: None, kind: Some("initialization"), target_refs: &["periph.timer3"], steps: &[metadata::SemanticOperationStep { index: 0, action: "write", target_ref: Some("reg.timer3.ctl"), expression: Some(metadata::SemanticExpression { language: Some("plain"), text: "Set TAEN = 1" }), value: None, description: Some("Set TAEN to start Timer A.") }], preconditions: &[], postconditions: &[] }];
pub const DRV_TIMER3_STATE_MACHINES: &[metadata::SemanticStateMachine] = &[metadata::SemanticStateMachine { id: "sm.timer3.a", name: "TIMER3A enable state", description: None, target_refs: &["periph.timer3"], initial_state: Some("disabled"), states: &[metadata::SemanticState { name: "disabled", description: Some("Timer A is not enabled."), invariants: &[] }, metadata::SemanticState { name: "running", description: Some("Timer A is enabled and counting."), invariants: &[] }], transitions: &[metadata::SemanticTransition { from: "disabled", to: "running", trigger: Some("Set CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "starts-hardware", target_ref: Some("field.timer3.ctl.taen"), description: Some("Timer A starts counting when TAEN is set.") }] }, metadata::SemanticTransition { from: "running", to: "disabled", trigger: Some("Clear CTL.TAEN"), conditions: &[], effects: &[metadata::SemanticSideEffect { kind: "stops-hardware", target_ref: Some("field.timer3.ctl.taen"), description: Some("Timer A stops when TAEN is cleared.") }] }] }];
