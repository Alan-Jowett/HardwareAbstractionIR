...
pub const DRV_NVIC_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
    ...
    metadata::InterruptSource {
        id: "isrc.gpioa",
        name: "GPIOA interrupt source",
        source_ref: "periph.gpioa",
        producer_ref: Some("periph.gpioa"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.gpiob",
        name: "GPIOB interrupt source",
        source_ref: "periph.gpiob",
        producer_ref: Some("periph.gpiob"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.gpioc",
        name: "GPIOC interrupt source",
        source_ref: "periph.gpioc",
        producer_ref: Some("periph.gpioc"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.gpiod",
        name: "GPIOD interrupt source",
        source_ref: "periph.gpiod",
        producer_ref: Some("periph.gpiod"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.gpioe",
        name: "GPIOE interrupt source",
        source_ref: "periph.gpioe",
        producer_ref: Some("periph.gpioe"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.gpiof",
        name: "GPIOF interrupt source",
        source_ref: "periph.gpiof",
        producer_ref: Some("periph.gpiof"),
        kind: "gpio",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    ...
    metadata::InterruptSource {
        id: "isrc.watchdog0",
        name: "WATCHDOG0 interrupt source",
        source_ref: "periph.watchdog0",
    ...
    metadata::InterruptSource {
        id: "isrc.sysctl",
        name: "SYSCTL interrupt source",
        source_ref: "periph.sysctl",
        producer_ref: Some("periph.sysctl"),
        kind: "peripheral",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
    metadata::InterruptSource {
        id: "isrc.flash",
        name: "FLASH interrupt source",
        source_ref: "periph.flash_ctrl",
        producer_ref: Some("periph.flash_ctrl"),
        kind: "peripheral",
        flag_refs: &[],
        clear_operation_refs: &[],
    },
...
pub const DRV_NVIC_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
    ...
    metadata::InterruptRoute {
        id: "iroute.gpioa",
        name: "GPIOA interrupt source route",
        source_ref: "isrc.gpioa",
        interrupt_ref: "int.gpioa",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.gpiob",
        name: "GPIOB interrupt source route",
        source_ref: "isrc.gpiob",
        interrupt_ref: "int.gpiob",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.gpioc",
        name: "GPIOC interrupt source route",
        source_ref: "isrc.gpioc",
        interrupt_ref: "int.gpioc",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        ...
        source_ref: "isrc.gpiod",
        interrupt_ref: "int.gpiod",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.gpioe",
        name: "GPIOE interrupt source route",
        source_ref: "isrc.gpioe",
        interrupt_ref: "int.gpioe",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.gpiof",
        name: "GPIOF interrupt source route",
        source_ref: "isrc.gpiof",
        interrupt_ref: "int.gpiof",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.watchdog0",
        name: "WATCHDOG0 interrupt source route",
        source_ref: "isrc.watchdog0",
        interrupt_ref: "int.watchdog0",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.sysctl",
        name: "SYSCTL interrupt source route",
        source_ref: "isrc.sysctl",
        interrupt_ref: "int.sysctl",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.flash",
        name: "FLASH interrupt source route",
        source_ref: "isrc.flash",
        interrupt_ref: "int.flash",
        controller_ref: "block.nvic",
        cpu_target_ref: Some("block.cpu0"),
        line_index: None,
        route_type: "hardwired",
