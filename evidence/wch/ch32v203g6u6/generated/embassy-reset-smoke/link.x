/* Local copy of riscv-rt link.x with absolute RAM-init boundary symbols. */
...
If you are linking to C code compiled using the `gcc` crate then modify your build
script to compile the C code without the -fPIC flag.");
