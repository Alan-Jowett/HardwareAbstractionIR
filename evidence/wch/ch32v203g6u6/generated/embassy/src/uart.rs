...
pub const DRV_USART1_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.usart1.tx.pa9.r0",
        name: "USART1 TX on PA9 (remap 0)",
        pin_ref: "pin.pa9",
        peripheral_ref: "periph.usart1",
        signal: "TX",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.tx.pb6.r1",
        name: "USART1 TX on PB6 (remap 1)",
        pin_ref: "pin.pb6",
        peripheral_ref: "periph.usart1",
        signal: "TX",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.tx.pa6.r3",
        name: "USART1 TX on PA6 (remap 3)",
        pin_ref: "pin.pa6",
        peripheral_ref: "periph.usart1",
        signal: "TX",
        route_type: "selectable",
...
pub const DRV_USART1_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.usart1.rx.pa10.r0",
        name: "USART1 RX on PA10 (remap 0)",
        pin_ref: "pin.pa10",
        peripheral_ref: "periph.usart1",
        signal: "RX",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.rx.pb7.r1",
        name: "USART1 RX on PB7 (remap 1)",
        pin_ref: "pin.pb7",
        peripheral_ref: "periph.usart1",
        signal: "RX",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.rx.pa7.r3",
        name: "USART1 RX on PA7 (remap 3)",
        pin_ref: "pin.pa7",
        peripheral_ref: "periph.usart1",
        signal: "RX",
        route_type: "selectable",
...
pub const DRV_USART1_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.usart1.ck.pa10.r2",
        name: "USART1 CK on PA10 (remap 2)",
        pin_ref: "pin.pa10",
        peripheral_ref: "periph.usart1",
        signal: "CK",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.ck.pa5.r3",
        name: "USART1 CK on PA5 (remap 3)",
        pin_ref: "pin.pa5",
        peripheral_ref: "periph.usart1",
        signal: "CK",
        route_type: "selectable",
...
pub const DRV_USART1_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.usart1.cts.pa11.r0",
        name: "USART1 CTS on PA11 (remap 0)",
        pin_ref: "pin.pa11",
        peripheral_ref: "periph.usart1",
        signal: "CTS",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.cts.pa11.r1",
        name: "USART1 CTS on PA11 (remap 1)",
        pin_ref: "pin.pa11",
        peripheral_ref: "periph.usart1",
        signal: "CTS",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.cts.pa5.r2",
        name: "USART1 CTS on PA5 (remap 2)",
        pin_ref: "pin.pa5",
        peripheral_ref: "periph.usart1",
        signal: "CTS",
        route_type: "selectable",
...
pub const DRV_USART1_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.usart1.rts.pa12.r0",
        name: "USART1 RTS on PA12 (remap 0)",
        pin_ref: "pin.pa12",
        peripheral_ref: "periph.usart1",
        signal: "RTS",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.rts.pa12.r1",
        name: "USART1 RTS on PA12 (remap 1)",
        pin_ref: "pin.pa12",
        peripheral_ref: "periph.usart1",
        signal: "RTS",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.usart1.rts.pa9.r2",
        name: "USART1 RTS on PA9 (remap 2)",
        pin_ref: "pin.pa9",
        peripheral_ref: "periph.usart1",
        signal: "RTS",
        route_type: "selectable",
