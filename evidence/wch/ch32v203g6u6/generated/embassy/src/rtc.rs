...
pub const DRV_RTC_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[
...
pub const DRV_RTC_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
...
pub const DRV_RTC_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
