...
pub const DRV_TIM1_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.tim1",
...
pub const DRV_TIM1_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.tim1",
...
pub const DRV_TIM1_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
...
pub const DRV_TIM1_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
...
pub const DRV_TIM1_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.tim1.etr.pa12.r0",
        name: "TIM1 ETR on PA12 (remap 0)",
        pin_ref: "pin.pa12",
        peripheral_ref: "periph.tim1",
        signal: "ETR",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.tim1.etr.pa12.r1",
        name: "TIM1 ETR on PA12 (remap 1)",
        pin_ref: "pin.pa12",
        peripheral_ref: "periph.tim1",
        signal: "ETR",
        route_type: "selectable",
...
pub const DRV_TIM1_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.tim1.bkin.pa6.r1",
    name: "TIM1 BKIN on PA6 (remap 1)",
    pin_ref: "pin.pa6",
    peripheral_ref: "periph.tim1",
    signal: "BKIN",
    route_type: "selectable",
...
pub const DRV_TIM1_PIN_ROLE_5_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLE_6_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLE_7_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
...
pub const DRV_TIM1_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "ch2",
        signal: "CH2",
        routes: DRV_TIM1_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch3",
        signal: "CH3",
        routes: DRV_TIM1_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch4",
        signal: "CH4",
        routes: DRV_TIM1_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "etr",
        signal: "ETR",
        routes: DRV_TIM1_PIN_ROLE_3_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "bkin",
        signal: "BKIN",
        routes: DRV_TIM1_PIN_ROLE_4_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch1n",
        signal: "CH1N",
        routes: DRV_TIM1_PIN_ROLE_5_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch2n",
    ...
    metadata::PinRole {
        role: "ch3n",
        signal: "CH3N",
        routes: DRV_TIM1_PIN_ROLE_7_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
pub const DRV_TIM1_INIT_OPERATIONS: &[metadata::SemanticOperation] =
...
pub const DRV_TIM1_STATE_MACHINES: &[metadata::SemanticStateMachine] =
...
pub const DRV_TIM2_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.tim2",
...
pub const DRV_TIM2_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.tim2",
...
pub const DRV_TIM2_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
    metadata::InterruptSource {
        id: "isrc.tim2.up",
...
pub const DRV_TIM2_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
    metadata::InterruptRoute {
        id: "iroute.tim2.up",
...
pub const DRV_TIM2_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM2_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM2_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM2_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM2_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.tim2.etr.pa0.r0",
        name: "TIM2 ETR on PA0 (remap 0)",
        pin_ref: "pin.pa0",
        peripheral_ref: "periph.tim2",
        signal: "ETR",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.tim2.etr.pa15.r1",
        name: "TIM2 ETR on PA15 (remap 1)",
        pin_ref: "pin.pa15",
        peripheral_ref: "periph.tim2",
        signal: "ETR",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.tim2.etr.pa0.r2",
        name: "TIM2 ETR on PA0 (remap 2)",
        pin_ref: "pin.pa0",
        peripheral_ref: "periph.tim2",
        signal: "ETR",
        route_type: "selectable",
    ...
    metadata::PinRoute {
        id: "pinroute.tim2.etr.pa15.r3",
        name: "TIM2 ETR on PA15 (remap 3)",
        pin_ref: "pin.pa15",
        peripheral_ref: "periph.tim2",
        signal: "ETR",
        route_type: "selectable",
...
pub const DRV_TIM2_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "ch1",
        signal: "CH1",
        routes: DRV_TIM2_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch2",
        signal: "CH2",
        routes: DRV_TIM2_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch3",
        signal: "CH3",
        routes: DRV_TIM2_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch4",
        signal: "CH4",
        routes: DRV_TIM2_PIN_ROLE_3_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "etr",
        signal: "ETR",
        routes: DRV_TIM2_PIN_ROLE_4_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
pub const DRV_TIM2_INIT_OPERATIONS: &[metadata::SemanticOperation] =
    &[metadata::SemanticOperation {
        id: "op.tim2.enable",
...
pub const DRV_TIM2_STATE_MACHINES: &[metadata::SemanticStateMachine] =
    &[metadata::SemanticStateMachine {
        id: "sm.tim2",
...
pub const DRV_TIM3_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.tim3",
...
pub const DRV_TIM3_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.tim3",
...
pub const DRV_TIM3_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
    metadata::InterruptSource {
        id: "isrc.tim3.up",
...
pub const DRV_TIM3_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
    metadata::InterruptRoute {
        id: "iroute.tim3.up",
...
pub const DRV_TIM3_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM3_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM3_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM3_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
...
pub const DRV_TIM3_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "ch1",
        signal: "CH1",
        routes: DRV_TIM3_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch2",
        signal: "CH2",
        routes: DRV_TIM3_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch3",
        signal: "CH3",
        routes: DRV_TIM3_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch4",
        signal: "CH4",
        routes: DRV_TIM3_PIN_ROLE_3_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
pub const DRV_TIM3_INIT_OPERATIONS: &[metadata::SemanticOperation] =
    &[metadata::SemanticOperation {
        id: "op.tim3.enable",
...
pub const DRV_TIM3_STATE_MACHINES: &[metadata::SemanticStateMachine] =
    &[metadata::SemanticStateMachine {
        id: "sm.tim3",
...
pub const DRV_TIM4_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.tim4",
...
pub const DRV_TIM4_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.tim4",
...
pub const DRV_TIM4_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
    metadata::InterruptSource {
        id: "isrc.tim4.up",
...
pub const DRV_TIM4_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
    metadata::InterruptRoute {
        id: "iroute.tim4.up",
...
pub const DRV_TIM4_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
...
pub const DRV_TIM4_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
...
pub const DRV_TIM4_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "ch1",
        signal: "CH1",
        routes: DRV_TIM4_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "ch2",
        signal: "CH2",
        routes: DRV_TIM4_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
pub const DRV_TIM4_INIT_OPERATIONS: &[metadata::SemanticOperation] =
    &[metadata::SemanticOperation {
        id: "op.tim4.enable",
...
pub const DRV_TIM4_STATE_MACHINES: &[metadata::SemanticStateMachine] =
    &[metadata::SemanticStateMachine {
        id: "sm.tim4",
