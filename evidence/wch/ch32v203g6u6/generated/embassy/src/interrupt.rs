...
pub const DRV_PFIC_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[
    metadata::InterruptSource {
        id: "isrc.usart1.global",
        name: "USART1 GLOBAL interrupt source",
    ...
    metadata::InterruptSource {
        ...
        name: "USART2 GLOBAL interrupt source",
    ...
    metadata::InterruptSource {
        id: "isrc.spi1.global",
        name: "SPI1 GLOBAL interrupt source",
    ...
    metadata::InterruptSource {
        id: "isrc.rtc.global",
        name: "RTC global interrupt source",
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel2",
        name: "DMA1 channel 2 interrupt source",
        source_ref: "dmach.dma1.ch2",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel3",
        name: "DMA1 channel 3 interrupt source",
        source_ref: "dmach.dma1.ch3",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel4",
        name: "DMA1 channel 4 interrupt source",
        source_ref: "dmach.dma1.ch4",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel5",
        name: "DMA1 channel 5 interrupt source",
        source_ref: "dmach.dma1.ch5",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel6",
        name: "DMA1 channel 6 interrupt source",
        source_ref: "dmach.dma1.ch6",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel7",
        name: "DMA1 channel 7 interrupt source",
        source_ref: "dmach.dma1.ch7",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
    ...
    metadata::InterruptSource {
        id: "isrc.dma1.channel8",
        name: "DMA1 channel 8 interrupt source",
        source_ref: "dmach.dma1.ch8",
        producer_ref: None,
        kind: "dma",
        flag_refs: &[],
        clear_operation_refs: &[],
...
pub const DRV_PFIC_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[
    metadata::InterruptRoute {
        id: "iroute.usart1.global",
        name: "USART1 GLOBAL interrupt route",
        source_ref: "isrc.usart1.global",
        interrupt_ref: "int.usart1",
    ...
    metadata::InterruptRoute {
        ...
        name: "USART2 GLOBAL interrupt route",
        source_ref: "isrc.usart2.global",
        interrupt_ref: "int.usart2",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        ...
        name: "SPI1 GLOBAL interrupt route",
        source_ref: "isrc.spi1.global",
        interrupt_ref: "int.spi1",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.rtc.global",
        name: "RTC global interrupt route",
        source_ref: "isrc.rtc.global",
        interrupt_ref: "int.rtc",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel2",
        name: "DMA1 channel 2 interrupt route",
        source_ref: "isrc.dma1.channel2",
        interrupt_ref: "int.dma1channel2",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel3",
        name: "DMA1 channel 3 interrupt route",
        source_ref: "isrc.dma1.channel3",
        interrupt_ref: "int.dma1channel3",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel4",
        name: "DMA1 channel 4 interrupt route",
        source_ref: "isrc.dma1.channel4",
        interrupt_ref: "int.dma1channel4",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel5",
        name: "DMA1 channel 5 interrupt route",
        source_ref: "isrc.dma1.channel5",
        interrupt_ref: "int.dma1channel5",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel6",
        name: "DMA1 channel 6 interrupt route",
        source_ref: "isrc.dma1.channel6",
        interrupt_ref: "int.dma1channel6",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel7",
        name: "DMA1 channel 7 interrupt route",
        source_ref: "isrc.dma1.channel7",
        interrupt_ref: "int.dma1channel7",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
    ...
    metadata::InterruptRoute {
        id: "iroute.dma1.channel8",
        name: "DMA1 channel 8 interrupt route",
        source_ref: "isrc.dma1.channel8",
        interrupt_ref: "int.dma1channel8",
        controller_ref: "block.pfic",
        cpu_target_ref: None,
        line_index: None,
        route_type: "hardwired",
