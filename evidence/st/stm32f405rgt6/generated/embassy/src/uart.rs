...
pub const DRV_UART4_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.uart4",
    name: "UART4 clock",
    consumer_ref: "periph.uart4",
    clock_ref: "clk.pclk1",
...
pub const DRV_UART4_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.uart4",
    name: "UART4 reset",
    target_ref: "periph.uart4",
    controller_ref: Some("block.rcc"),
...
pub const DRV_UART4_INTERRUPT_SOURCES: &[metadata::InterruptSource] =
...
pub const DRV_UART4_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute {
...
pub const DRV_UART4_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.uart4.tx.pa0",
        name: "UART4 TX on PA0",
        pin_ref: "pin.pa0",
        peripheral_ref: "periph.uart4",
        signal: "TX",
        route_type: "muxed",
        control_refs: &[],
    ...
    metadata::PinRoute {
        id: "pinroute.uart4.tx.pc10",
        name: "UART4 TX on PC10",
        pin_ref: "pin.pc10",
        peripheral_ref: "periph.uart4",
        signal: "TX",
        route_type: "muxed",
...
pub const DRV_UART4_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.uart4.rx.pa1",
        name: "UART4 RX on PA1",
        pin_ref: "pin.pa1",
        peripheral_ref: "periph.uart4",
        signal: "RX",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.uart4.rx.pc11",
        name: "UART4 RX on PC11",
        pin_ref: "pin.pc11",
        peripheral_ref: "periph.uart4",
        signal: "RX",
        route_type: "muxed",
...
pub const DRV_UART4_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "tx",
        signal: "TX",
        routes: DRV_UART4_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "rx",
        signal: "RX",
        routes: DRV_UART4_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
...
pub struct Uart4RuntimeResources {}

pub const DRV_UART4_RUNTIME_RESOURCES: Uart4RuntimeResources = Uart4RuntimeResources {};

#[derive(Debug, Clone, Copy)]
pub struct Uart4MetadataResources {
...
pub const DRV_UART4_METADATA_RESOURCES: Uart4MetadataResources = Uart4MetadataResources {
...
impl Uart4 {
    pub fn new(resources: Uart4RuntimeResources) -> Result<Self, metadata::Error> {
        let _ = resources;
        Ok(Self)
    }

    pub fn metadata_resources() -> Uart4MetadataResources {
        DRV_UART4_METADATA_RESOURCES
    }
...
pub const DRV_UART5_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.uart5",
    name: "UART5 clock",
    consumer_ref: "periph.uart5",
    clock_ref: "clk.pclk1",
    controller_ref: Some("block.rcc"),
    binding_kind: "gated",
    control_refs: &["reg.rcc.apb1enr"],
...
pub const DRV_UART5_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.uart5",
    name: "UART5 reset",
    target_ref: "periph.uart5",
    controller_ref: Some("block.rcc"),
    reset_domain_ref: Some("rdom.apb1"),
    binding_kind: "software",
    control_refs: &["reg.rcc.apb1rstr"],
...
pub const DRV_UART5_INTERRUPT_SOURCES: &[metadata::InterruptSource] =
    &[metadata::InterruptSource {
...
pub const DRV_UART5_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute {
...
pub const DRV_UART5_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.uart5.tx.pc12",
    name: "UART5 TX on PC12",
    pin_ref: "pin.pc12",
    peripheral_ref: "periph.uart5",
    signal: "TX",
    route_type: "muxed",
    control_refs: &[],
    electrical_constraint_refs: &[],
...
pub const DRV_UART5_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.uart5.rx.pd2",
    name: "UART5 RX on PD2",
    pin_ref: "pin.pd2",
    peripheral_ref: "periph.uart5",
    signal: "RX",
    route_type: "muxed",
...
pub const DRV_UART5_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "tx",
        signal: "TX",
        routes: DRV_UART5_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "rx",
        signal: "RX",
        routes: DRV_UART5_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
...
#[derive(Debug, Clone, Copy)]
pub struct Uart5RuntimeResources {}

pub const DRV_UART5_RUNTIME_RESOURCES: Uart5RuntimeResources = Uart5RuntimeResources {};

#[derive(Debug, Clone, Copy)]
pub struct Uart5MetadataResources {
    pub clocks: &'static [metadata::ClockBinding],
    pub resets: &'static [metadata::ResetBinding],
    pub interrupt_sources: &'static [metadata::InterruptSource],
    pub interrupts: &'static [metadata::InterruptRoute],
...
pub const DRV_UART5_METADATA_RESOURCES: Uart5MetadataResources = Uart5MetadataResources {
...
impl Uart5 {
    pub fn new(resources: Uart5RuntimeResources) -> Result<Self, metadata::Error> {
        let _ = resources;
        Ok(Self)
    }

    pub fn metadata_resources() -> Uart5MetadataResources {
        DRV_UART5_METADATA_RESOURCES
    }
