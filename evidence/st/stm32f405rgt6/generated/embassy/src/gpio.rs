...
pub const DRV_GPIOA_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    ...
    controller_ref: Some("block.rcc"),
    reset_domain_ref: Some("rdom.ahb1"),
    binding_kind: "software",
    control_refs: &["reg.rcc.ahb1rstr"],
...
pub const DRV_GPIOA_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio0.pa0",
    name: "GPIOA GPIO0 on PA0",
    pin_ref: "pin.pa0",
...
pub const DRV_GPIOA_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio1.pa1",
    name: "GPIOA GPIO1 on PA1",
    pin_ref: "pin.pa1",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO1",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio10.pa10",
    name: "GPIOA GPIO10 on PA10",
    pin_ref: "pin.pa10",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO10",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio11.pa11",
    name: "GPIOA GPIO11 on PA11",
    pin_ref: "pin.pa11",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO11",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio12.pa12",
    name: "GPIOA GPIO12 on PA12",
    pin_ref: "pin.pa12",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO12",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_5_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio13.pa13",
    name: "GPIOA GPIO13 on PA13",
    pin_ref: "pin.pa13",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO13",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_6_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio14.pa14",
    name: "GPIOA GPIO14 on PA14",
    pin_ref: "pin.pa14",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO14",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_7_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio15.pa15",
    name: "GPIOA GPIO15 on PA15",
    pin_ref: "pin.pa15",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO15",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_8_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio2.pa2",
    name: "GPIOA GPIO2 on PA2",
    pin_ref: "pin.pa2",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO2",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_9_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio3.pa3",
    name: "GPIOA GPIO3 on PA3",
    pin_ref: "pin.pa3",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO3",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_10_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio4.pa4",
    name: "GPIOA GPIO4 on PA4",
    pin_ref: "pin.pa4",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO4",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_11_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio5.pa5",
    name: "GPIOA GPIO5 on PA5",
    pin_ref: "pin.pa5",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO5",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_12_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio6.pa6",
    name: "GPIOA GPIO6 on PA6",
    pin_ref: "pin.pa6",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO6",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_13_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio7.pa7",
    name: "GPIOA GPIO7 on PA7",
    pin_ref: "pin.pa7",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO7",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_14_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio8.pa8",
    name: "GPIOA GPIO8 on PA8",
    pin_ref: "pin.pa8",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO8",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLE_15_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioa.gpio9.pa9",
    name: "GPIOA GPIO9 on PA9",
    pin_ref: "pin.pa9",
    peripheral_ref: "periph.gpioa",
    signal: "GPIO9",
    route_type: "hardwired",
...
pub const DRV_GPIOA_PIN_ROLES: &[metadata::PinRole] = &[
    ...
    metadata::PinRole {
        role: "gpio9",
        signal: "GPIO9",
        routes: DRV_GPIOA_PIN_ROLE_15_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
...
impl GpioAFlex {
    ...
    pub fn set_as_output(&self, initial_level: Level) -> Result<(), metadata::Error> {
        ...
        modify_u32(
            self.moder_addr,
            self.moder_clear_mask,
            self.moder_output_mask,
        )?;
        Ok(())
    }
...
pub const DRV_GPIOB_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio0.pb0",
    name: "GPIOB GPIO0 on PB0",
    pin_ref: "pin.pb0",
...
pub const DRV_GPIOB_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio1.pb1",
    name: "GPIOB GPIO1 on PB1",
    pin_ref: "pin.pb1",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO1",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio10.pb10",
    name: "GPIOB GPIO10 on PB10",
    pin_ref: "pin.pb10",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO10",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio11.pb11",
    name: "GPIOB GPIO11 on PB11",
    pin_ref: "pin.pb11",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO11",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio12.pb12",
    name: "GPIOB GPIO12 on PB12",
    pin_ref: "pin.pb12",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO12",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_5_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio13.pb13",
    name: "GPIOB GPIO13 on PB13",
    pin_ref: "pin.pb13",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO13",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_6_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio14.pb14",
    name: "GPIOB GPIO14 on PB14",
    pin_ref: "pin.pb14",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO14",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_7_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio15.pb15",
    name: "GPIOB GPIO15 on PB15",
    pin_ref: "pin.pb15",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO15",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_8_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio2.pb2",
    name: "GPIOB GPIO2 on PB2",
    pin_ref: "pin.pb2",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO2",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_9_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio3.pb3",
    name: "GPIOB GPIO3 on PB3",
    pin_ref: "pin.pb3",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO3",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_10_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio4.pb4",
    name: "GPIOB GPIO4 on PB4",
    pin_ref: "pin.pb4",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO4",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_11_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio5.pb5",
    name: "GPIOB GPIO5 on PB5",
    pin_ref: "pin.pb5",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO5",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_12_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio6.pb6",
    name: "GPIOB GPIO6 on PB6",
    pin_ref: "pin.pb6",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO6",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_13_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio7.pb7",
    name: "GPIOB GPIO7 on PB7",
    pin_ref: "pin.pb7",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO7",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_14_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio8.pb8",
    name: "GPIOB GPIO8 on PB8",
    pin_ref: "pin.pb8",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO8",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLE_15_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiob.gpio9.pb9",
    name: "GPIOB GPIO9 on PB9",
    pin_ref: "pin.pb9",
    peripheral_ref: "periph.gpiob",
    signal: "GPIO9",
    route_type: "hardwired",
...
pub const DRV_GPIOB_PIN_ROLES: &[metadata::PinRole] = &[
    ...
    metadata::PinRole {
        role: "gpio2",
        signal: "GPIO2",
        routes: DRV_GPIOB_PIN_ROLE_8_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio3",
        signal: "GPIO3",
        routes: DRV_GPIOB_PIN_ROLE_9_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio4",
        signal: "GPIO4",
        routes: DRV_GPIOB_PIN_ROLE_10_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio5",
        signal: "GPIO5",
        routes: DRV_GPIOB_PIN_ROLE_11_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio6",
        signal: "GPIO6",
        routes: DRV_GPIOB_PIN_ROLE_12_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio7",
        signal: "GPIO7",
        routes: DRV_GPIOB_PIN_ROLE_13_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio8",
        signal: "GPIO8",
        routes: DRV_GPIOB_PIN_ROLE_14_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio9",
        signal: "GPIO9",
        routes: DRV_GPIOB_PIN_ROLE_15_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
...
pub const DRV_GPIOC_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio0.pc0",
    name: "GPIOC GPIO0 on PC0",
    pin_ref: "pin.pc0",
...
pub const DRV_GPIOC_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio1.pc1",
    name: "GPIOC GPIO1 on PC1",
    pin_ref: "pin.pc1",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO1",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio10.pc10",
    name: "GPIOC GPIO10 on PC10",
    pin_ref: "pin.pc10",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO10",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio11.pc11",
    name: "GPIOC GPIO11 on PC11",
    pin_ref: "pin.pc11",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO11",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio12.pc12",
    name: "GPIOC GPIO12 on PC12",
    pin_ref: "pin.pc12",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO12",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_5_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio13.pc13",
    name: "GPIOC GPIO13 on PC13",
    pin_ref: "pin.pc13",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO13",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_6_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio14.pc14",
    name: "GPIOC GPIO14 on PC14",
    pin_ref: "pin.pc14",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO14",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_7_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio15.pc15",
    name: "GPIOC GPIO15 on PC15",
    pin_ref: "pin.pc15",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO15",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_8_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio2.pc2",
    name: "GPIOC GPIO2 on PC2",
    pin_ref: "pin.pc2",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO2",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_9_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio3.pc3",
    name: "GPIOC GPIO3 on PC3",
    pin_ref: "pin.pc3",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO3",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_10_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio4.pc4",
    name: "GPIOC GPIO4 on PC4",
    pin_ref: "pin.pc4",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO4",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_11_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio5.pc5",
    name: "GPIOC GPIO5 on PC5",
    pin_ref: "pin.pc5",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO5",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_12_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio6.pc6",
    name: "GPIOC GPIO6 on PC6",
    pin_ref: "pin.pc6",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO6",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_13_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio7.pc7",
    name: "GPIOC GPIO7 on PC7",
    pin_ref: "pin.pc7",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO7",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_14_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio8.pc8",
    name: "GPIOC GPIO8 on PC8",
    pin_ref: "pin.pc8",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO8",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLE_15_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioc.gpio9.pc9",
    name: "GPIOC GPIO9 on PC9",
    pin_ref: "pin.pc9",
    peripheral_ref: "periph.gpioc",
    signal: "GPIO9",
    route_type: "hardwired",
...
pub const DRV_GPIOC_PIN_ROLES: &[metadata::PinRole] = &[
    ...
    metadata::PinRole {
        role: "gpio2",
        signal: "GPIO2",
        routes: DRV_GPIOC_PIN_ROLE_8_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio3",
        signal: "GPIO3",
        routes: DRV_GPIOC_PIN_ROLE_9_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio4",
        signal: "GPIO4",
        routes: DRV_GPIOC_PIN_ROLE_10_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio5",
        signal: "GPIO5",
        routes: DRV_GPIOC_PIN_ROLE_11_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio6",
        signal: "GPIO6",
        routes: DRV_GPIOC_PIN_ROLE_12_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio7",
        signal: "GPIO7",
        routes: DRV_GPIOC_PIN_ROLE_13_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio8",
        signal: "GPIO8",
        routes: DRV_GPIOC_PIN_ROLE_14_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio9",
        signal: "GPIO9",
        routes: DRV_GPIOC_PIN_ROLE_15_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
...
pub const DRV_GPIOD_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpiod.gpio2.pd2",
    name: "GPIOD GPIO2 on PD2",
    pin_ref: "pin.pd2",
...
pub const DRV_GPIOD_PIN_ROLES: &[metadata::PinRole] = &[metadata::PinRole {
    role: "gpio2",
    signal: "GPIO2",
...
pub const DRV_GPIOH_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.gpioh",
    name: "GPIOH clock",
    consumer_ref: "periph.gpioh",
    clock_ref: "clk.hclk1",
    controller_ref: Some("block.rcc"),
    binding_kind: "gated",
    control_refs: &["reg.rcc.ahb1enr"],
...
pub const DRV_GPIOH_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.gpioh",
    name: "GPIOH reset",
    target_ref: "periph.gpioh",
    controller_ref: Some("block.rcc"),
    reset_domain_ref: Some("rdom.ahb1"),
    binding_kind: "software",
    control_refs: &["reg.rcc.ahb1rstr"],
...
pub const DRV_GPIOH_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioh.gpio0.ph0",
    name: "GPIOH GPIO0 on PH0",
    pin_ref: "pin.ph0",
    peripheral_ref: "periph.gpioh",
    signal: "GPIO0",
    route_type: "hardwired",
    control_refs: &[],
    electrical_constraint_refs: &[],
...
pub const DRV_GPIOH_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.gpioh.gpio1.ph1",
    name: "GPIOH GPIO1 on PH1",
    pin_ref: "pin.ph1",
    peripheral_ref: "periph.gpioh",
    signal: "GPIO1",
    route_type: "hardwired",
...
pub const DRV_GPIOH_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "gpio0",
        signal: "GPIO0",
        routes: DRV_GPIOH_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "gpio1",
        signal: "GPIO1",
        routes: DRV_GPIOH_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
];
