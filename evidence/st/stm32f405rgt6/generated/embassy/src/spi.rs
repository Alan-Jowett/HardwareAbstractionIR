...
pub const DRV_SPI1_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.spi1",
    name: "SPI1 clock",
...
pub const DRV_SPI1_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.spi1",
    name: "SPI1 reset",
...
pub const DRV_SPI1_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource {
    id: "isrc.spi1.global",
...
pub const DRV_SPI1_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute {
...
pub const DRV_SPI1_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi1.sck.pa5",
        name: "SPI1 SCK on PA5",
        pin_ref: "pin.pa5",
    ...
    metadata::PinRoute {
        id: "pinroute.spi1.sck.pb3",
        name: "SPI1 SCK on PB3",
        pin_ref: "pin.pb3",
        peripheral_ref: "periph.spi1",
        signal: "SCK",
        route_type: "muxed",
...
pub const DRV_SPI1_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi1.mosi.pa7",
        name: "SPI1 MOSI on PA7",
        pin_ref: "pin.pa7",
        peripheral_ref: "periph.spi1",
        signal: "MOSI",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi1.mosi.pb5",
        name: "SPI1 MOSI on PB5",
        pin_ref: "pin.pb5",
        peripheral_ref: "periph.spi1",
        signal: "MOSI",
        route_type: "muxed",
...
pub const DRV_SPI1_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi1.miso.pa6",
        name: "SPI1 MISO on PA6",
        pin_ref: "pin.pa6",
        peripheral_ref: "periph.spi1",
        signal: "MISO",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi1.miso.pb4",
        name: "SPI1 MISO on PB4",
        pin_ref: "pin.pb4",
        peripheral_ref: "periph.spi1",
        signal: "MISO",
        route_type: "muxed",
...
pub const DRV_SPI1_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi1.nss.pa15",
        name: "SPI1 NSS on PA15",
        pin_ref: "pin.pa15",
        peripheral_ref: "periph.spi1",
        signal: "NSS",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi1.nss.pa4",
        name: "SPI1 NSS on PA4",
        pin_ref: "pin.pa4",
        peripheral_ref: "periph.spi1",
        signal: "NSS",
        route_type: "muxed",
...
pub const DRV_SPI1_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "sck",
        signal: "SCK",
        routes: DRV_SPI1_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "mosi",
        signal: "MOSI",
        routes: DRV_SPI1_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "miso",
        signal: "MISO",
        routes: DRV_SPI1_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "nss",
        signal: "NSS",
        routes: DRV_SPI1_PIN_ROLE_3_ROUTES,
...
pub const DRV_SPI2_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.spi2",
    name: "SPI2 clock",
    consumer_ref: "periph.spi2",
    clock_ref: "clk.pclk1",
    controller_ref: Some("block.rcc"),
    binding_kind: "gated",
...
pub const DRV_SPI2_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.spi2",
    name: "SPI2 reset",
    target_ref: "periph.spi2",
    controller_ref: Some("block.rcc"),
...
pub const DRV_SPI2_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource {
    id: "isrc.spi2.global",
...
pub const DRV_SPI2_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute {
...
pub const DRV_SPI2_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi2.sck.pb10",
        name: "SPI2 SCK on PB10",
        pin_ref: "pin.pb10",
        peripheral_ref: "periph.spi2",
        signal: "SCK",
        route_type: "muxed",
        control_refs: &[],
        electrical_constraint_refs: &[],
    ...
    metadata::PinRoute {
        id: "pinroute.spi2.sck.pb13",
        name: "SPI2 SCK on PB13",
        pin_ref: "pin.pb13",
        peripheral_ref: "periph.spi2",
        signal: "SCK",
        route_type: "muxed",
...
pub const DRV_SPI2_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi2.mosi.pb15",
        name: "SPI2 MOSI on PB15",
        pin_ref: "pin.pb15",
        peripheral_ref: "periph.spi2",
        signal: "MOSI",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi2.mosi.pc3",
        name: "SPI2 MOSI on PC3",
        pin_ref: "pin.pc3",
        peripheral_ref: "periph.spi2",
        signal: "MOSI",
        route_type: "muxed",
...
pub const DRV_SPI2_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi2.miso.pb14",
        name: "SPI2 MISO on PB14",
        pin_ref: "pin.pb14",
        peripheral_ref: "periph.spi2",
        signal: "MISO",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi2.miso.pc2",
        name: "SPI2 MISO on PC2",
        pin_ref: "pin.pc2",
        peripheral_ref: "periph.spi2",
        signal: "MISO",
        route_type: "muxed",
...
pub const DRV_SPI2_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi2.nss.pb12",
        name: "SPI2 NSS on PB12",
        pin_ref: "pin.pb12",
        peripheral_ref: "periph.spi2",
        signal: "NSS",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi2.nss.pb9",
        name: "SPI2 NSS on PB9",
        pin_ref: "pin.pb9",
        peripheral_ref: "periph.spi2",
        signal: "NSS",
        route_type: "muxed",
...
pub const DRV_SPI2_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "sck",
        signal: "SCK",
        routes: DRV_SPI2_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "mosi",
        signal: "MOSI",
        routes: DRV_SPI2_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "miso",
        signal: "MISO",
        routes: DRV_SPI2_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "nss",
        signal: "NSS",
        routes: DRV_SPI2_PIN_ROLE_3_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
...
pub const DRV_SPI3_CLOCK_BINDINGS: &[metadata::ClockBinding] = &[metadata::ClockBinding {
    id: "clk.spi3",
    name: "SPI3 clock",
    consumer_ref: "periph.spi3",
    clock_ref: "clk.pclk1",
    controller_ref: Some("block.rcc"),
    binding_kind: "gated",
    control_refs: &["reg.rcc.apb1enr"],
...
pub const DRV_SPI3_RESET_BINDINGS: &[metadata::ResetBinding] = &[metadata::ResetBinding {
    id: "rst.spi3",
    name: "SPI3 reset",
    target_ref: "periph.spi3",
    controller_ref: Some("block.rcc"),
    reset_domain_ref: Some("rdom.apb1"),
    binding_kind: "software",
    control_refs: &["reg.rcc.apb1rstr"],
...
pub const DRV_SPI3_INTERRUPT_SOURCES: &[metadata::InterruptSource] = &[metadata::InterruptSource {
    id: "isrc.spi3.global",
...
pub const DRV_SPI3_INTERRUPT_ROUTES: &[metadata::InterruptRoute] = &[metadata::InterruptRoute {
...
pub const DRV_SPI3_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi3.sck.pb3",
        name: "SPI3 SCK on PB3",
        pin_ref: "pin.pb3",
        peripheral_ref: "periph.spi3",
        signal: "SCK",
        route_type: "muxed",
        control_refs: &[],
        electrical_constraint_refs: &[],
    ...
    metadata::PinRoute {
        id: "pinroute.spi3.sck.pc10",
        name: "SPI3 SCK on PC10",
        pin_ref: "pin.pc10",
        peripheral_ref: "periph.spi3",
        signal: "SCK",
        route_type: "muxed",
...
pub const DRV_SPI3_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi3.mosi.pb5",
        name: "SPI3 MOSI on PB5",
        pin_ref: "pin.pb5",
        peripheral_ref: "periph.spi3",
        signal: "MOSI",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi3.mosi.pc12",
        name: "SPI3 MOSI on PC12",
        pin_ref: "pin.pc12",
        peripheral_ref: "periph.spi3",
        signal: "MOSI",
        route_type: "muxed",
...
pub const DRV_SPI3_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi3.miso.pb4",
        name: "SPI3 MISO on PB4",
        pin_ref: "pin.pb4",
        peripheral_ref: "periph.spi3",
        signal: "MISO",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi3.miso.pc11",
        name: "SPI3 MISO on PC11",
        pin_ref: "pin.pc11",
        peripheral_ref: "periph.spi3",
        signal: "MISO",
        route_type: "muxed",
...
pub const DRV_SPI3_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.spi3.nss.pa15",
        name: "SPI3 NSS on PA15",
        pin_ref: "pin.pa15",
        peripheral_ref: "periph.spi3",
        signal: "NSS",
        route_type: "muxed",
    ...
    metadata::PinRoute {
        id: "pinroute.spi3.nss.pa4",
        name: "SPI3 NSS on PA4",
        pin_ref: "pin.pa4",
        peripheral_ref: "periph.spi3",
        signal: "NSS",
        route_type: "muxed",
...
pub const DRV_SPI3_PIN_ROLES: &[metadata::PinRole] = &[
    metadata::PinRole {
        role: "sck",
        signal: "SCK",
        routes: DRV_SPI3_PIN_ROLE_0_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "mosi",
        signal: "MOSI",
        routes: DRV_SPI3_PIN_ROLE_1_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "miso",
        signal: "MISO",
        routes: DRV_SPI3_PIN_ROLE_2_ROUTES,
        requirement: metadata::ResourceRequirement::Required,
    },
    metadata::PinRole {
        role: "nss",
        signal: "NSS",
        routes: DRV_SPI3_PIN_ROLE_3_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
