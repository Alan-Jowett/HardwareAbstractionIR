...
pub const DRV_SPI2_DMA_CHANNELS: &[metadata::DmaChannel] = &[
    metadata::DmaChannel {
        id: "dma.tx_ch0",
        name: "GDMA TX channel 0",
        controller_ref: "block.gdma0",
        target_ref: None,
        channel_index: 0,
        capabilities: &["tx", "peripheral"],
        priority_levels: &[],
    },
    metadata::DmaChannel {
        id: "dma.rx_ch0",
...
pub const DRV_SPI2_DMA_ROUTES: &[metadata::DmaRoute] = &[
    metadata::DmaRoute {
        id: "dmaroute.spi2.tx.ch0",
        name: "SPI2 TX via GDMA channel 0",
        peripheral_ref: "per.spi2",
        signal: Some("FSPID"),
        channel_ref: "dma.tx_ch0",
        direction: "memory-to-peripheral",
        control_refs: &["reg.dma.out_peri_sel_ch0"],
        shared_channel_group_ref: None,
    },
    metadata::DmaRoute {
        id: "dmaroute.spi2.rx.ch0",
        name: "SPI2 RX via GDMA channel 0",
        peripheral_ref: "per.spi2",
        signal: Some("FSPIQ"),
    ...
    metadata::DmaRoute {
        id: "dmaroute.spi2.tx.ch1",
        name: "SPI2 TX via GDMA channel 1",
        peripheral_ref: "per.spi2",
        signal: Some("FSPID"),
        channel_ref: "dma.tx_ch1",
        direction: "memory-to-peripheral",
        control_refs: &["reg.dma.out_peri_sel_ch1"],
        shared_channel_group_ref: None,
    },
    metadata::DmaRoute {
        id: "dmaroute.spi2.rx.ch1",
        name: "SPI2 RX via GDMA channel 1",
        peripheral_ref: "per.spi2",
        signal: Some("FSPIQ"),
    ...
    metadata::DmaRoute {
        id: "dmaroute.spi2.tx.ch2",
        name: "SPI2 TX via GDMA channel 2",
        peripheral_ref: "per.spi2",
        signal: Some("FSPID"),
        channel_ref: "dma.tx_ch2",
        direction: "memory-to-peripheral",
        control_refs: &["reg.dma.out_peri_sel_ch2"],
        shared_channel_group_ref: None,
    },
    metadata::DmaRoute {
        id: "dmaroute.spi2.rx.ch2",
        name: "SPI2 RX via GDMA channel 2",
        peripheral_ref: "per.spi2",
        signal: Some("FSPIQ"),
...
pub const DRV_SPI2_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.clk.gpio6",
    name: "SPI2 CLK on GPIO6",
    pin_ref: "pin.gpio6",
    peripheral_ref: "per.spi2",
    signal: "FSPICLK",
...
pub const DRV_SPI2_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.d.gpio7",
    name: "SPI2 D on GPIO7",
    pin_ref: "pin.gpio7",
    peripheral_ref: "per.spi2",
    signal: "FSPID",
    route_type: "hardwired",
...
pub const DRV_SPI2_PIN_ROLE_2_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.q.gpio2",
    name: "SPI2 Q on GPIO2",
    pin_ref: "pin.gpio2",
    peripheral_ref: "per.spi2",
    signal: "FSPIQ",
    route_type: "hardwired",
...
pub const DRV_SPI2_PIN_ROLE_3_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.cs.gpio10",
    name: "SPI2 CS0 on GPIO10",
    pin_ref: "pin.gpio10",
    peripheral_ref: "per.spi2",
    signal: "FSPICS0",
    route_type: "hardwired",
...
pub const DRV_SPI2_PIN_ROLE_4_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.wp.gpio5",
    name: "SPI2 WP on GPIO5",
    pin_ref: "pin.gpio5",
    peripheral_ref: "per.spi2",
    signal: "FSPIWP",
    route_type: "hardwired",
...
pub const DRV_SPI2_PIN_ROLE_5_ROUTES: &[metadata::PinRoute] = &[metadata::PinRoute {
    id: "pinroute.spi2.hd.gpio4",
    name: "SPI2 HD on GPIO4",
    pin_ref: "pin.gpio4",
    peripheral_ref: "per.spi2",
    signal: "FSPIHD",
    route_type: "hardwired",
...
pub const DRV_SPI2_PIN_ROLES: &[metadata::PinRole] = &[
    ...
    metadata::PinRole {
        role: "wp",
        signal: "FSPIWP",
        routes: DRV_SPI2_PIN_ROLE_4_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
    metadata::PinRole {
        role: "hd",
        signal: "FSPIHD",
        routes: DRV_SPI2_PIN_ROLE_5_ROUTES,
        requirement: metadata::ResourceRequirement::Optional,
    },
];
pub const DRV_SPI2_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[
    metadata::SemanticOperation {
        id: "op.spi2.enable_clock_gate",
        name: "Enable SPI2 clock gate",
        description: None,
        kind: Some("initialization"),
        target_refs: &["per.spi2"],
        steps: &[metadata::SemanticOperationStep {
            index: 0,
            action: "write",
            target_ref: Some("reg.spi2.clk_gate"),
            expression: Some(metadata::SemanticExpression {
                language: Some("plain"),
                text: "Set CLK_EN",
            }),
            value: None,
            description: Some("Enable the SPI2 internal functional clock."),
        }],
        preconditions: &[],
        postconditions: &[],
    },
    metadata::SemanticOperation {
        id: "op.spi2.start_transaction",
        name: "Start SPI2 user transaction",
        description: None,
        ...
        steps: &[metadata::SemanticOperationStep {
            index: 0,
            action: "write",
            target_ref: Some("reg.spi2.cmd"),
            expression: Some(metadata::SemanticExpression {
                language: Some("plain"),
                text: "Set USR",
            }),
            value: None,
            description: Some("Start the programmed SPI2 user transaction."),
        }],
        preconditions: &[],
        postconditions: &[],
    },
