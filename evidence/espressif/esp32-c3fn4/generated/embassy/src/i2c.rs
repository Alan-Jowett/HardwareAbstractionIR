...
pub const DRV_I2C0_PIN_ROLE_0_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio0",
        name: "I2C0 SCL on GPIO0",
        pin_ref: "pin.gpio0",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
        control_refs: &[],
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio1",
        name: "I2C0 SCL on GPIO1",
        pin_ref: "pin.gpio1",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio2",
        name: "I2C0 SCL on GPIO2",
        pin_ref: "pin.gpio2",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio3",
        name: "I2C0 SCL on GPIO3",
        pin_ref: "pin.gpio3",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio4",
        name: "I2C0 SCL on GPIO4",
        pin_ref: "pin.gpio4",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio5",
        name: "I2C0 SCL on GPIO5",
        pin_ref: "pin.gpio5",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio6",
        name: "I2C0 SCL on GPIO6",
        pin_ref: "pin.gpio6",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio7",
        name: "I2C0 SCL on GPIO7",
        pin_ref: "pin.gpio7",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio8",
        name: "I2C0 SCL on GPIO8",
        pin_ref: "pin.gpio8",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio9",
        name: "I2C0 SCL on GPIO9",
        pin_ref: "pin.gpio9",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio10",
        name: "I2C0 SCL on GPIO10",
        pin_ref: "pin.gpio10",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio11",
        name: "I2C0 SCL on GPIO11",
        pin_ref: "pin.gpio11",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio12",
        name: "I2C0 SCL on GPIO12",
        pin_ref: "pin.gpio12",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio13",
        name: "I2C0 SCL on GPIO13",
        pin_ref: "pin.gpio13",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio14",
        name: "I2C0 SCL on GPIO14",
        pin_ref: "pin.gpio14",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio15",
        name: "I2C0 SCL on GPIO15",
        pin_ref: "pin.gpio15",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio16",
        name: "I2C0 SCL on GPIO16",
        pin_ref: "pin.gpio16",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio17",
        name: "I2C0 SCL on GPIO17",
        pin_ref: "pin.gpio17",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio18",
        name: "I2C0 SCL on GPIO18",
        pin_ref: "pin.gpio18",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio19",
        name: "I2C0 SCL on GPIO19",
        pin_ref: "pin.gpio19",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio20",
        name: "I2C0 SCL on GPIO20",
        pin_ref: "pin.gpio20",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.scl.gpio21",
        name: "I2C0 SCL on GPIO21",
        pin_ref: "pin.gpio21",
        peripheral_ref: "per.i2c0",
        signal: "SCL",
        route_type: "matrix",
...
pub const DRV_I2C0_PIN_ROLE_1_ROUTES: &[metadata::PinRoute] = &[
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio0",
        name: "I2C0 SDA on GPIO0",
        pin_ref: "pin.gpio0",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio1",
        name: "I2C0 SDA on GPIO1",
        pin_ref: "pin.gpio1",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio2",
        name: "I2C0 SDA on GPIO2",
        pin_ref: "pin.gpio2",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio3",
        name: "I2C0 SDA on GPIO3",
        pin_ref: "pin.gpio3",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio4",
        name: "I2C0 SDA on GPIO4",
        pin_ref: "pin.gpio4",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio5",
        name: "I2C0 SDA on GPIO5",
        pin_ref: "pin.gpio5",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio6",
        name: "I2C0 SDA on GPIO6",
        pin_ref: "pin.gpio6",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio7",
        name: "I2C0 SDA on GPIO7",
        pin_ref: "pin.gpio7",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio8",
        name: "I2C0 SDA on GPIO8",
        pin_ref: "pin.gpio8",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio9",
        name: "I2C0 SDA on GPIO9",
        pin_ref: "pin.gpio9",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio10",
        name: "I2C0 SDA on GPIO10",
        pin_ref: "pin.gpio10",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio11",
        name: "I2C0 SDA on GPIO11",
        pin_ref: "pin.gpio11",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio12",
        name: "I2C0 SDA on GPIO12",
        pin_ref: "pin.gpio12",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio13",
        name: "I2C0 SDA on GPIO13",
        pin_ref: "pin.gpio13",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio14",
        name: "I2C0 SDA on GPIO14",
        pin_ref: "pin.gpio14",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio15",
        name: "I2C0 SDA on GPIO15",
        pin_ref: "pin.gpio15",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio16",
        name: "I2C0 SDA on GPIO16",
        pin_ref: "pin.gpio16",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio17",
        name: "I2C0 SDA on GPIO17",
        pin_ref: "pin.gpio17",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio18",
        name: "I2C0 SDA on GPIO18",
        pin_ref: "pin.gpio18",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio19",
        name: "I2C0 SDA on GPIO19",
        pin_ref: "pin.gpio19",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio20",
        name: "I2C0 SDA on GPIO20",
        pin_ref: "pin.gpio20",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
    ...
    metadata::PinRoute {
        id: "pinroute.i2c0.sda.gpio21",
        name: "I2C0 SDA on GPIO21",
        pin_ref: "pin.gpio21",
        peripheral_ref: "per.i2c0",
        signal: "SDA",
        route_type: "matrix",
...
pub const DRV_I2C0_INIT_OPERATIONS: &[metadata::SemanticOperation] = &[
    metadata::SemanticOperation {
        id: "op.i2c0.configure_controller",
        name: "Configure I2C0 controller mode",
        description: None,
        kind: Some("configuration"),
        target_refs: &["per.i2c0"],
        steps: &[
            metadata::SemanticOperationStep {
                index: 0,
                action: "write",
                target_ref: Some("reg.i2c0.ctr"),
                expression: Some(metadata::SemanticExpression {
                    language: Some("plain"),
                    text: "Set MS_MODE",
                }),
                value: None,
                description: Some("Place I2C0 into master mode."),
            },
            metadata::SemanticOperationStep {
                index: 1,
                action: "write",
                ...
                value: None,
                description: Some("Enable the I2C controller clock."),
            },
            metadata::SemanticOperationStep {
                index: 2,
                action: "write",
                ...
                expression: Some(metadata::SemanticExpression {
                    language: Some("plain"),
                    text: "Set CONF_UPGATE",
                }),
                value: None,
                description: Some("Commit the controller configuration to hardware."),
            },
        ],
        preconditions: &[],
        postconditions: &[],
    ...
    metadata::SemanticOperation {
        ...
        steps: &[metadata::SemanticOperationStep {
            ...
            expression: Some(metadata::SemanticExpression {
                language: Some("plain"),
                text: "Set TRANS_START",
            }),
            value: None,
            description: Some("Start the programmed I2C transaction."),
        }],
        preconditions: &[],
        postconditions: &[],
    },
...
pub struct I2c0RuntimeResources {}

pub const DRV_I2C0_RUNTIME_RESOURCES: I2c0RuntimeResources = I2c0RuntimeResources {};

#[derive(Debug, Clone, Copy)]
pub struct I2c0MetadataResources {
...
pub const DRV_I2C0_METADATA_RESOURCES: I2c0MetadataResources = I2c0MetadataResources {
...
impl I2c0 {
    pub fn new(resources: I2c0RuntimeResources) -> Result<Self, metadata::Error> {
        let _ = resources;
        Ok(Self)
    }

    pub fn metadata_resources() -> I2c0MetadataResources {
        DRV_I2C0_METADATA_RESOURCES
    }
